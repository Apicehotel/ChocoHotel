        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              padding: "8px 10px",
              borderRadius: 9,
              border: "1.5px solid " + (mode === m ? "#7C5A3A" : "#E4E0D6"),
              background: mode === m ? "#7C5A3A" : "#fff",
            ...
            return (
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  cursor: "pointer",
                  border: "1.5px solid " + (sel ? "#7C5A3A" : "#E4E0D6"),
                  background: sel ? "#E6F2EB" : "#fff",
                  color: sel ? "#7C5A3A" : "#5C645E",
                }}
              >
                {f.fam}
              </button>
        ...
        {PLANNING_VIEWS.map((v) => (
          <button
            ...
            style={{
              ...
              borderRadius: 10,
              border: "1px solid #E4E0D6",
              background: view === v.key ? "#7C5A3A" : "#fff",
      ...
      {menuOpen && (
        <>
          ...
          >
            ...
            <div style={{ borderTop: "1px solid #F6F1E8" }}>
              <button
                onClick={() => {
                  logout();
                  setMenuOpen(false);
      ...
      >
        ...
        <div
          style={{
            ...
            height: 34,
            borderRadius: 9,
            background: sel ? accent + "22" : "#F6F1E8",
            display: "grid",
            placeItems: "center",
            flexShrink: 0,
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
          ...
          {eligible.length > 0 && (
            <>
              ...
              {eligible.map((u) => (
                <AssigneeRow key={u.id} u={u} accent="#7C5A3A" />
              ))}{" "}
            </>
          )}{" "}
          {extTec.length > 0 && (
    ...
    <Sheet onClose={onClose} title={"Camera " + p.room + " · Intervento"}>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      height: 32,
                      borderRadius: 8,
                      background: a.isExt ? "#FEF3C7" : "#7C5A3A14",
                      display: "grid",
                      placeItems: "center",
                      color: a.isExt ? "#92400E" : "#7C5A3A",
                    }}
                  >
                    {" "}
      ...
      {canOrderPiece && !showRepl && (
        <button
          ...
          style={{ ...ctaSt, background: "#7C5A3A", marginBottom: 10 }}
        >
...
function Detail({
  ...
  const askTecnico = async () => {
    ...
    try {
      ...
      await fetch(
        "https://CHOCOHOTEL-DA-CONFIGURARE.supabase.co/functions/v1/send-push",
        {
          method: "POST",
              ...
              >
                ...
                <div style={{ display: "flex", gap: 7 }}>
                  <button
                    onClick={saveReplaced}
                    disabled={!repl.trim()}
                    style={{ ...ctaSt, background: "#7C5A3A", flex: 1 }}
                  >
                    {I.check} Salva
                  </button>
                  <button
          ...
          {[0, 1, 2, 3].map((i) => (
            <div
              ...
              style={{
                ...
                height: 16,
                borderRadius: "50%",
                background: pin.length > i ? "#7C5A3A" : "#E4E0D6",
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button
              ...
              style={{ ...ctaSt, flex: 1, background: "#7C5A3A" }}
            >
        ...
        {["reception", "manutentore"].map((s) => (
          <button
            ...
            style={{
              ...
              padding: 11,
              borderRadius: 11,
              border: "1.5px solid " + (sender === s ? "#7C5A3A" : "#E4E0D6"),
              background: sender === s ? "#FBFAF7" : "#fff",
              fontWeight: 700,
              fontSize: 13,
              color: sender === s ? "#7C5A3A" : "#5C645E",
              cursor: "pointer",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
